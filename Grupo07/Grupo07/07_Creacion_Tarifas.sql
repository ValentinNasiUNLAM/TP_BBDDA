...
EXEC actividades.CrearDeporte @nombre = 'Vóley', @precio = 30000;
EXEC actividades.CrearDeporte @nombre = 'Taekwondo', @precio = 25000;
EXEC actividades.CrearDeporte @nombre = 'Baile artístico', @precio = 30000;
EXEC actividades.CrearDeporte @nombre = 'Natación', @precio = 45000;
